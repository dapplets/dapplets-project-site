        ...
        <div className={cn(styles.wrapper)}>
          <div className={cn(styles.content)}>
            ...
            <div className={cn(styles.imgBlock)}>
              <Image src={'/img/modal.png'} width={820} height={350} alt={''} />
            </div>
            <div className={cn(styles.textBlock)}>
              ...
              <p className={cn(styles.text)}>
                ...
                powerful in the hope of his benevolence. We need to find a new
                balance of power between the owner and the user community.
              ...
              <p className={cn(styles.text)}>
                ...
                his physical control. Therefore, the user always has the power
                to customize the UX and share it within the community. It is
                what the Mutable Web is for.
              </p>
              <p className={cn(styles.text)}>
                Mutable Web is a
