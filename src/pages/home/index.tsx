    ...
    <Layout darkMode={isDarkMode} toggleDarkMode={toggleDarkMode}>
      <div className="flex flex-col fonts container-xl mx-auto ">
        <div className={cn(styles.titleWrapper, "flex flex-col")}>
          ...
          >
            <div className={cn(styles.titleBlockTitle, "flex")}>
              {HomeTitle.title}
            </div>
            <div className={cn(styles.titleBlockSubtitle, "flex text-base")}>
              {HomeTitle.subtitle}
            </div>
          </div>
          <div className={cn(styles.titleButtons, "flex justify-between mx-auto")}>
